    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center p-6">
          <div className="glass rounded-2xl p-6 border-white/20 max-w-md text-center">
            <h2 className="text-xl font-semibold mb-2">Something went wrong</h2>
            <p className="text-white/70 text-sm mb-4">{this.state.message}</p>
            <button
...
export default function Landing() {
  ...
  // Add: Online/Offline status handling for graceful agent/network issues
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen relative overflow-hidden">
        ...
        {/* Add: Offline status banner for agent/network issues */}
        {!isOnline && (
          <div className="relative z-10 px-6">
            <div className="glass border-white/20 text-yellow-200 text-sm rounded-xl p-3 text-center">
                ...
                <CardContent className="p-0">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      if (!img || img.src.endsWith("/logo.png")) return;
                      img.src = "/logo.png";
                    }}
                  />
